...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\receive_node\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/receive_node/local_setup.bat"
